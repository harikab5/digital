...
export default function AboutUs() {
  ...
  <section className="w-full bg-white py-20 flex flex-col items-center">
        ...
        <div className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 px-4">
          {[
            { year: "2018", color: "from-pink-500 to-red-400", title: "Started Our Journey", desc: "Launched as a boutique agency<br/>for local businesses." },
            { year: "2019", color: "from-yellow-400 to-orange-500", title: "First SEO Success", desc: "Achieved top Google rankings<br/>and 200% organic growth." },
            ...
            { year: "2021", color: "from-green-400 to-lime-500", title: "Data-Driven Results", desc: "Adopted analytics and automation<br/>for measurable ROI." },
            { year: "2022", color: "from-cyan-400 to-blue-500", title: "Award-Winning Campaigns", desc: "Won awards for creative PPC<br/>and content marketing." },
            { year: "2023", color: "from-blue-700 to-blue-400", title: "Full-Service Agency", desc: "Became a full-service partner<br/>for web, SEO, PPC, social." },
          ].map((item, i) => (
            <div
              key={i}
      ...
      <section className="w-full py-16 bg-[#f8f6ff] flex flex-col items-center">
        <div className="w-full max-w-5xl flex flex-col md:flex-row gap-10 items-center justify-center">
          ...
          <div className="flex-1 flex flex-col gap-8 min-w-[260px] max-w-md">
            <div className="bg-white rounded-[2.5rem] shadow-xl p-8 flex flex-col items-center text-center">
              ...
              <p className="text-gray-700 text-base">To empower businesses of all sizes to thrive in the digital world by delivering innovative, data-driven marketing solutions that inspire growth and lasting impact.</p>
            </div>
            <div className="bg-white rounded-[2.5rem] shadow-xl p-8 flex flex-col items-center text-center">
              <h3 className="text-2xl font-bold mb-3" style={{color:'#a259c6'}}>Our Mission</h3>
              <p className="text-gray-700 text-base">To partner with our clients on their digital journey, providing expert guidance, creative strategies, and measurable results that drive their business forward.</p>
            </div>
          </div>
        </div>
      </section>
  ...
  <section className="w-full py-16 bg-white flex flex-col items-center">
        <div className="w-full max-w-6xl flex flex-col md:flex-row gap-10 items-center justify-between">
          {/* Left: Content */}
          <div className="flex-1 min-w-0 flex flex-col items-start justify-center pr-0 md:pr-8">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4" style={{color:'black'}}>What We Think</h2>
            <div className="space-y-5 w-full">
              <div className="rounded-2xl bg-[#232136] bg-opacity-90 text-white p-6 border-l-4 border-[#a259c6] shadow-md">
                ...
                <p className="text-sm">We address the complete business journey—not just campaigns, but the root of digital growth—through integrated, comprehensive marketing solutions.</p>
              </div>
              <div className="rounded-2xl bg-[#232136] bg-opacity-90 text-white p-6 border-l-4 border-[#a259c6] shadow-md">
                <h3 className="font-bold text-lg mb-1">Personalized Care</h3>
                <p className="text-sm">Every brand is unique. We believe digital marketing solutions should be tailored to your goals, audience, and industry for maximum results.</p>
              </div>
              <div className="rounded-2xl bg-[#232136] bg-opacity-90 text-white p-6 border-l-4 border-[#53295a] shadow-md">
                ...
                <p className="text-sm">We combine creative strategy with proven analytics and the latest technology to deliver measurable, sustainable growth for your business.</p>
              </div>
            </div>
          </div>
          {/* Right: Image */}
          <div className="flex-1 min-w-0 flex items-center justify-center">
            <div className="w-full max-w-xl aspect-square rounded-3xl overflow-hidden shadow-2xl bg-[#232136] flex items-center justify-center">
      ...
      <section className="w-full py-16 bg-[#f7f7f7] flex flex-col items-center">
        <h2 className="text-3xl md:text-4xl font-extrabold mb-12 tracking-wide text-[#232136]">What Makes Us Unique</h2>
        <div className="w-full max-w-6xl flex flex-col md:flex-row gap-10 items-center justify-between px-4">
          {/* Left: Unique Image */}
            <div className="flex-1 flex items-center justify-center mb-8 md:mb-0">
              <div className="w-full max-w-md h-[600px] rounded-3xl overflow-hidden shadow-2xl bg-[#e6f0fa] flex items-center justify-center">
                <img src={uniqueImg} alt="Unique Digital Marketing" className="w-full h-full object-cover" />
              </div>
            </div>
          {/* Right: Overlapping Cards */}
            <div className="flex-1 flex flex-col items-center min-w-[320px] max-w-md relative" style={{minHeight:'600px'}}>
              {/* Card 1 - Top (Light Purple) */}
              <div className="rounded-2xl shadow-xl p-8 flex flex-col items-start min-h-[110px] bg-[#e6e6fa] border-l-8 border-[#7fc8ca] w-full absolute left-0 z-60" style={{top:'0%', width:'100%'}}>
                <h3 className="font-bold text-lg text-[#232136]">Integrated Digital Solutions</h3>
              </div>
              {/* Card 2 (White) */}
              <div className="rounded-2xl shadow-xl p-8 flex flex-col items-start min-h-[110px] bg-white border-l-8 border-[#232136] w-full absolute left-0 z-50" style={{top:'16%', width:'100%'}}>
                <h3 className="font-bold text-lg text-[#232136]">Data-Driven Personalization</h3>
              </div>
              {/* Card 3 (Light Purple) */}
              <div className="rounded-2xl shadow-xl p-8 flex flex-col items-start min-h-[110px] bg-[#e6e6fa] border-l-8 border-[#7fc8ca] w-full absolute left-0 z-40" style={{top:'32%', width:'100%'}}>
                <h3 className="font-bold text-lg text-[#232136]">Expert-Led Innovation</h3>
              </div>
              {/* Card 4 (White) */}
              <div className="rounded-2xl shadow-xl p-8 flex flex-col items-start min-h-[110px] bg-white border-l-8 border-[#232136] w-full absolute left-0 z-30" style={{top:'48%', width:'100%'}}>
                <h3 className="font-bold text-lg text-[#232136]">Transparent Communication</h3>
              </div>
              {/* Card 5 (Light Purple) */}
              <div className="rounded-2xl shadow-xl p-8 flex flex-col items-start min-h-[110px] bg-[#e6e6fa] border-l-8 border-[#7fc8ca] w-full absolute left-0 z-20" style={{top:'64%', width:'100%'}}>
                <h3 className="font-bold text-lg text-[#232136]">Client Collaboration</h3>
              </div>
              {/* Card 6 (White) */}
              <div className="rounded-2xl shadow-xl p-8 flex flex-col items-start min-h-[110px] bg-white border-l-8 border-[#232136] w-full absolute left-0 z-10" style={{top:'80%', width:'100%'}}>
      ...
      {/* Our Values Section */}
      <section className="w-full py-16 bg-white flex flex-col items-center">
        <h2 className="text-3xl md:text-4xl font-extrabold mb-12 tracking-wide text-[#232136]">Our Values</h2>
